...
<div class="header py-2 py-lg-2">
  <div class="container">
    ...
    <div class="row mt-5">
      <div class="col-md-12">
        <h1 class="text-dark">Slider Terbaru</h1>
      </div>
      @foreach($data as $i => $value)
      <div class="col-lg-6 mb-4">
        <div class="card card-stats mb-4 mb-xl-0">
          <a href="{{ route('home.slider.detail', $value->id) }}">
          ...
          <div class="card-body">
            ...
            <a href="{{ route('home.slider.detail', $value->id) }}" class="btn btn-info">Lihat Detail</a>
          </div>
        </div>
      </div>
      @endforeach
