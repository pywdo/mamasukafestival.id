          ...
          <div class="row align-items-center">
            ...
            <div class=" col">
              <ul class="nav nav-pills justify-content-end">
                <li class="nav-item">
                  <a class="btn btn-info btn-md" href="client/create">Tambah</a>
                </li>
              </ul>
            </div>
          </div>
                ...
                <tr>
                  ...
                  <td class="text-center">
                   <form action="{{ route('admin.client.destroy',$value->id) }}" method="POST">
                      <a class="btn btn-primary btn-sm" href="{{ route('admin.client.edit',$value->id) }}">Edit</a>
                      @csrf
                      @method('DELETE')
                  ...
                  <td class="text-center">
                    <a href="{{ asset('images') }}/{{ $value->thumbnail }}" target="_blank" rel="noopener noreferrer">
                      <img src="{{ asset('images') }}/{{ $value->thumbnail }}" width="70px" height="50px">
                    </a>
                  </td>
                </tr>
                @endforeach
