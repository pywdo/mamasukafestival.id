          ...
          <div class="row align-items-center">
            ...
            <div class=" col">
              <ul class="nav nav-pills justify-content-end">
                <li class="nav-item">
                  <a class="btn btn-info btn-md" href="{{ route('admin.event.create') }}">Tambah</a>
                </li>
              </ul>
            </div>
          </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <form action="{{ route('admin.event.destroy',$value->id) }}" method="POST">
                      <a class="btn btn-primary btn-sm" href="{{ route('admin.event.edit',$value->id) }}">Edit</a>
                      @csrf
                      @method('DELETE')
